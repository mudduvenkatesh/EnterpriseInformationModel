...
public interface EIMModelFactory {
	 ...
	 * @return
	 */
	Organization createOgranization(String baseIRI,String id,String name,String label);
	/**
	 ...
	 * @return
	 */
	Organization createOgranization(String baseIRI,String name,String label);
