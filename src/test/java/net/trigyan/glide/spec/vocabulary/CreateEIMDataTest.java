...
public class CreateEIMDataTest {
	...
	public void testCreateBaseData() {
		...
		Concept myOrg = new DefaultConcept("Organization", "MyEnterpriseBank");
		Concept sector = new DefaultConcept("OrgUnit", "Sector");
		Concept bu = new DefaultConcept("OrgUnit", "Business-Unit");
